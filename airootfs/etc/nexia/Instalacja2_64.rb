...
system "grub-install --target=i386-pc --recheck /dev/sda"
...
system "pacman -Sy"
system "pacman -S xorg-server xorg-xinit plasma-next kf5 kf5-aids pcmanfm-qt compass-kde-icon-theme ntfs-3g xdg-user-dirs chromium chromium-pepper-flash  xterm alsa-utils gksu p7zip base-devel ephifonts #{all} --noconfirm"
puts "
"
